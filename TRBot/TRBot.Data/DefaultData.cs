    ...
    public static class DefaultData
    {
        ...
        public static List<Settings> GetDefaultSettings()
        {
            List<Settings> defaultSettings = new List<Settings>()
            {
                ...
                SettingsHelper(DONATE_MESSAGE, "You can support TRBot's development by donating to the developer. All donations go towards improving TRBot: https://liberapay.com/kimimaru/"),
